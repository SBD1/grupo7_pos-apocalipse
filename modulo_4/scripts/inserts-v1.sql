...
INSERT INTO personagem(
    vida, nivel, caracteristica, capacidade_carregamento, defesa, ataque)
    VALUES (100, 1, 'Guerreiro incansável', 10, 1, 2);

INSERT INTO personagem(
    vida, nivel, caracteristica, capacidade_carregamento, defesa, ataque)
    VALUES (100, 100, 'Alienigena estranho', 10, 99, 99);

INSERT INTO sobrevivente(
    nome, furtividade, id_personagem, coordenadax, coordenaday, id_local)
    VALUES ('Carlos', 1, 1, 0, 0, 1);
...
INSERT INTO npc(
    nome, e_hostil, id_personagem, id_local, id_dialogo)
    VALUES ('Venon', true, 2, 1, 1);
